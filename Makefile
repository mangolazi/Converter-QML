...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sat Dec 14 07:27:24 2013
# Project:  Converter.pro
# Template: app
# Command: c:\qtsdk\symbian\sdks\symbian3qt474\bin\qmake.exe -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o bld.inf Converter.pro
#############################################################################
...
qmake:
	$(QMAKE) "C:/Qtapps/Converter/Converter.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

bld.inf: C:/Qtapps/Converter/Converter.pro
	$(QMAKE) "C:/Qtapps/Converter/Converter.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

c:\Qtapps\Converter\Converter.loc: 
	$(QMAKE) "C:/Qtapps/Converter/Converter.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

debug: c:\Qtapps\Converter\Converter.loc bld.inf
...
release: c:\Qtapps\Converter\Converter.loc bld.inf
...
debug-winscw: c:\Qtapps\Converter\Converter.loc bld.inf
...
debug-gcce: c:\Qtapps\Converter\Converter.loc bld.inf
...
release-armv6-gcce4.4.1: c:\Qtapps\Converter\Converter.loc bld.inf
...
run:
	call C:/QtSDK/Symbian/SDKs/Symbian3Qt474/epoc32/release/winscw/udeb/Converter.exe $(QT_RUN_OPTIONS)

runonphone: sis
	runonphone $(QT_RUN_ON_PHONE_OPTIONS) --sis Converter.sis Converter.exe $(QT_RUN_OPTIONS)

Converter_template.pkg: C:/Qtapps/Converter/Converter.pro
	$(MAKE) -f $(MAKEFILE) qmake

Converter_installer.pkg: C:/Qtapps/Converter/Converter.pro
	$(MAKE) -f $(MAKEFILE) qmake

Converter_stub.pkg: C:/Qtapps/Converter/Converter.pro
	$(MAKE) -f $(MAKEFILE) qmake

sis: Converter_template.pkg
...
ok_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) Converter_template.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_sis: Converter_template.pkg
...
ok_unsigned_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) -o Converter_template.pkg $(QT_SIS_TARGET)

Converter.sis:
	$(MAKE) -f $(MAKEFILE) sis

installer_sis: Converter_installer.pkg sis
	$(MAKE) -f $(MAKEFILE) ok_installer_sis

ok_installer_sis: Converter_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) Converter_installer.pkg - $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_installer_sis: Converter_installer.pkg unsigned_sis
	$(MAKE) -f $(MAKEFILE) ok_unsigned_installer_sis

ok_unsigned_installer_sis: Converter_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) -o Converter_installer.pkg

fail_sis_nocache:
	$(error Project has to be built or QT_SIS_TARGET environment variable has to be set before calling 'SIS' target)

stub_sis: Converter_stub.pkg
...
ok_stub_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -s $(QT_SIS_OPTIONS) Converter_stub.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)
...
moc\moc_qmlapplicationviewer.cpp: qmlapplicationviewer\qmlapplicationviewer.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Qtapps\Converter\qmlapplicationviewer\qmlapplicationviewer.h -o c:\Qtapps\Converter\moc\moc_qmlapplicationviewer.cpp
...
dodistclean:
	-@ if EXIST "c:\Qtapps\Converter\Converter_template.pkg" $(DEL_FILE)  "c:\Qtapps\Converter\Converter_template.pkg"
	-@ if EXIST "c:\Qtapps\Converter\Converter_stub.pkg" $(DEL_FILE)  "c:\Qtapps\Converter\Converter_stub.pkg"
	-@ if EXIST "c:\Qtapps\Converter\Converter_installer.pkg" $(DEL_FILE)  "c:\Qtapps\Converter\Converter_installer.pkg"
	-@ if EXIST "c:\Qtapps\Converter\Makefile" $(DEL_FILE)  "c:\Qtapps\Converter\Makefile"
	-@ if EXIST "c:\Qtapps\Converter\Converter_exe.mmp" $(DEL_FILE)  "c:\Qtapps\Converter\Converter_exe.mmp"
	-@ if EXIST "c:\Qtapps\Converter\Converter_reg.rss" $(DEL_FILE)  "c:\Qtapps\Converter\Converter_reg.rss"
	-@ if EXIST "c:\Qtapps\Converter\Converter.rss" $(DEL_FILE)  "c:\Qtapps\Converter\Converter.rss"
	-@ if EXIST "c:\Qtapps\Converter\Converter.loc" $(DEL_FILE)  "c:\Qtapps\Converter\Converter.loc"
	-@ if EXIST "c:\Qtapps\Converter\bld.inf" $(DEL_FILE)  "c:\Qtapps\Converter\bld.inf"
